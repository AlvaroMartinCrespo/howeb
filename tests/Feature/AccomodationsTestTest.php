...
class AccomodationsTest extends TestCase
{
    ...
    public function test_removeReservation()
    {
        ...
        // Verifica que el mensaje de eliminación esté presente en la sesión
        $this->assertTrue(session()->has('eliminate'));
        $this->assertEquals('Reservation removed!', session('eliminate'));
    }
}
